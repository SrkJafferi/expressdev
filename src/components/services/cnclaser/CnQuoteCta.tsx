        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal from="up" delay={0.1}>
            <h2 className="display-md mt-5 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-white">
              ...
              <br />
              Or Fabrication{" "}
              <span className="text-gradient-hero">Idea?</span>
            </h2>
          </Reveal>

          <Reveal from="up" delay={0.2}>
            <p className="lede mx-auto mt-5 max-w-xl text-white/65">
              Send us your artwork, dimensions, reference image or even a
              rough concept. Our team can help determine the right material
              and cutting approach for the final application.
            </p>
          </Reveal>

          <Reveal from="up" delay={0.3}>
            <QuoteInlineForm service="CNC & Laser Cutting" />
          </Reveal>
          ...
          <Reveal from="up" delay={0.4}>
            ...
            >
              Need signage or display production too? Explore Services
