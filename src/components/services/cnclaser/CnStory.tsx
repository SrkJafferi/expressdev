          ...
          <div className="flex flex-col justify-center lg:col-span-6">
            ...
            <Reveal from="up" delay={0.1}>
              <h2 className="display-md mt-7 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
                ...
                <br />
                Build{" "}
                <span className="text-gradient-deep">Around.</span>
              </h2>
            </Reveal>
            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  A small error in a digital file becomes a visible problem
                  once it is cut into material.
                </p>
                <p className="lede text-ink-2">
                  That is why artwork preparation, dimensions and cut paths
                  matter before fabrication begins.
                </p>
                <p className="lede text-ink-2">
                  We check geometry, scale and production setup so components
                  are made to fit the intended sign, display or environment.
                </p>
                <p className="lede text-ink-2">
                  For repeat jobs, the same approved production file helps
                  maintain consistency from one piece to the next.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal from="up" delay={0.3}>
              <div className="mt-10 flex items-center gap-5">
                ...
                <span className="label-wide text-ink-3">
                  Checked · Cut · Matched — One Team
                </span>
              </div>
            </Reveal>
          </div>

          {/* ── Right — cut component close-up ──────────────────────── */}
          <Reveal
            from="right"
            delay={0.2}
          ...
          >
            <div className="relative h-full min-h-[420px]">
              ...
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/60 shadow-[0_30px_70px_-28px_rgba(16,48,90,0.45)]">
                <Image
                  src="https://plus.unsplash.com/premium_photo-1682146121756-10d8209fe077?auto=format&fit=crop&w=1000&h=1250&q=85"
                  alt="Precision-cut component detail from CNC production"
                  fill
              ...
              <div className="absolute -left-4 top-6 rounded-xl border border-navy-100 bg-white/95 px-4 py-3 shadow-[0_16px_40px_-14px_rgba(16,48,90,0.35)] backdrop-blur-sm sm:-left-6">
                <p className="label-wide text-cyan">File-to-Fabrication</p>
