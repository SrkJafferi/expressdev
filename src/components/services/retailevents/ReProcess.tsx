...
const steps = [
  {
    index: "01",
    label: "PLAN",
    caption: "Space · Audience · Objectives",
    icon: "plan",
  ...
  },
  {
    index: "02",
    label: "DESIGN",
    caption: "Artwork · Scale · Placement",
    icon: "design",
  ...
  },
  {
    index: "03",
    label: "PRODUCE",
    caption: "Print · Fabricate · Assemble",
    icon: "produce",
  ...
  },
  {
    index: "04",
    label: "INSTALL",
    caption: "Position · Align · Handover",
    icon: "install",
      ...
      <div className="shell relative z-10">
        <div className="grid gap-8 lg:grid-cols-12">
          <Reveal from="up" className="lg:col-span-7">
            <SectionLabel accent="cyan">Space to experience</SectionLabel>
          ...
          >
            <p className="lede text-ink-2">
              Retail and event projects depend on more than artwork.
              Dimensions, flow, visibility, installation and the way people
              move through the space all affect the final result.
            </p>
          </Reveal>
        </div>
          ...
          <ol className="relative mx-auto mt-16 grid max-w-5xl grid-cols-2 gap-x-16 gap-y-10 lg:grid-cols-4">
            ...
            {steps.map((step) => (
              ...
              >
                ...
                >
                  <ReIcon name={step.icon} className="size-16" />
                </span>
        ...
        <Reveal from="up" delay={0.3}>
          <p className="label-wide mt-14 text-center text-ink-3">
            Every touchpoint built around the space and campaign
          </p>
        </Reveal>
      </div>
    </section>
