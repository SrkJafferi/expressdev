...
const proofPoints = [
  {
    label: "VISUAL IMPACT",
    body: "Graphics designed for high-footfall environments.",
    icon: "colour",
  },
  {
    label: "MODULAR DISPLAY",
    body: "Portable and reusable systems where suitable.",
    icon: "scale",
  },
  {
    label: "BRAND CONSISTENCY",
    body: "One visual language across multiple touchpoints.",
    icon: "workflow",
  },
  {
    label: "INSTALLATION SUPPORT",
    body: "Production and setup coordinated for the final location.",
    icon: "install",
  },
];

export function ReIntro() {
  return (
    <section className="relative isolate overflow-hidden bg-surface py-24 lg:py-32">
      ...
      <div className="shell relative z-10">
        <div className="grid items-stretch gap-12 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="flex flex-col justify-center lg:col-span-6">
            ...
            <Reveal from="up" delay={0.1}>
              <h2 className="display-md mt-7 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
                ...
                <br />
                To Show{" "}
                <span className="text-gradient-deep">Floor.</span>
              </h2>
            </Reveal>
            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  Your physical environment is one of the strongest places for
                  a brand to make an impression.
                </p>
                <p className="lede text-ink-2">
                  Express Advertising produces branded retail, storefront,
                  event and exhibition solutions for businesses across the UAE
                  — combining print, fabrication, display systems and
                  installation into one coordinated production workflow.
                </p>
                <p className="lede text-ink-2">
                  From a promotional counter or roll-up banner to a complete
                  branded event environment, we focus on visibility,
                  consistency and execution so every space feels intentional.
                </p>
              </div>
            </Reveal>
                ...
                {proofPoints.map((point) => (
                  <div key={point.label} className="group flex gap-3.5">
                    <span className="grid size-9 shrink-0 place-items-center rounded-lg border border-cyan/25 bg-cyan/5 text-cyan-bright transition-colors duration-300 group-hover:bg-cyan group-hover:text-white">
                      <ReIcon name={point.icon} className="size-4.5" />
                    </span>
                    <div>
          ...
          {/* ── Right — branded environment image ───────────────────── */}
          <Reveal
            from="right"
            delay={0.2}
