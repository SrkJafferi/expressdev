...
const useCases = [
  {
    label: "RETAIL STORES",
    body: "Storefront and in-store promotional branding.",
    image:
  ...
  },
  {
    ...
    body: "Temporary displays, campaign graphics and promotional zones.",
    image:
      "https://images.unsplash.com/photo-1761225646548-bc92fea0dc72?auto=format&fit=crop&w=800&q=85",
    alt: "Retail display zone in a mall environment",
  },
  {
    label: "EXHIBITIONS",
    body: "Portable branded systems and show-floor visual communication.",
    image: "/banner3.avif",
    alt: "Exhibition show-floor graphics and displays",
  },
  {
    label: "CONFERENCES",
    body: "Backdrops, counters, directional and presentation graphics.",
    image:
      "https://images.unsplash.com/photo-1505373877841-8d25f7d46678?auto=format&fit=crop&w=800&q=85",
    alt: "Conference environment with branded graphics",
  },
  {
    label: "PRODUCT LAUNCHES",
    body: "Branded environments and promotional display elements.",
    image: "/banner2.avif",
    alt: "Branded merchandise and displays for a product launch",
  },
  {
    label: "CORPORATE EVENTS",
    body: "Professional visual systems for internal and external events.",
    image:
      "https://images.unsplash.com/photo-1531058020387-3be344556be6?auto=format&fit=crop&w=800&q=85",
    alt: "Corporate event with branded visual systems",
  },
];

export function ReUseCases() {
  return (
      ...
      <div className="shell relative z-10">
        <div className="grid gap-8 lg:grid-cols-12">
          <Reveal from="up" className="lg:col-span-7">
            <SectionLabel accent="navy">Where we build visibility</SectionLabel>
