        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal from="up" delay={0.1}>
            <h2 className="display-md mt-5 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-white">
              Planning A Store Launch,
              <br />
              Event Or{" "}
              <span className="text-gradient-hero">Exhibition?</span>
            </h2>
          </Reveal>

          <Reveal from="up" delay={0.2}>
            <p className="lede mx-auto mt-5 max-w-xl text-white/65">
              Send us the venue, available dimensions, campaign artwork and
              the display items you need. Our team can help structure the
              right combination of graphics and display solutions for the
              space.
            </p>
          </Reveal>
          ...
          <Reveal from="up" delay={0.4}>
            ...
            >
              Need standard promotional products? Shop Online
