...
const benefits = [
  {
    ...
    body: "Artwork and production developed together.",
    icon: "design",
    accent: "cyan",
  },
  {
    title: "Site-Aware Production",
    body: "Dimensions and viewing position planned before fabrication.",
    icon: "survey",
    accent: "magenta",
  },
  {
    title: "Quality Finishing",
    body: "Clean edges, alignment and professional finishing.",
    icon: "acrylic",
    accent: "yellow",
  },
  {
    title: "UAE-Wide Execution",
    body: "Production and installation support across the UAE.",
    icon: "commercial",
    accent: "cyan",
  },
] as const;
  ...
  return (
    <section className="relative isolate overflow-hidden bg-navy-900 py-24 text-white lg:py-32">
      ...
      <div className="shell relative z-10">
        ...
        {/* 4-across benefit cards — big icon + one-line title + short body */}
            ...
            return (
              <Reveal key={item.title} from="up" delay={i * 0.1}>
                <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-white/25 sm:p-7">
                  ...
                  >
                    <SgIcon name={item.icon} className="size-9" />
                  </span>
