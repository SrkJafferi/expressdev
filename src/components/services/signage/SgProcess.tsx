...
const steps = [
  {
    index: "01",
    label: "SURVEY",
    caption: "Location · Size · Visibility",
    icon: "survey",
  ...
  },
  {
    index: "02",
    label: "DESIGN",
    caption: "Artwork · Scale · Structure",
    icon: "design",
  ...
  },
  {
    index: "04",
    label: "INSTALL",
    caption: "Fix · Align · Handover",
    icon: "install",
    accent: "border-yellow/70 text-[#c9a800]",
  },
] as const;

export function SgProcess() {
  return (
      ...
      <div className="shell relative z-10">
        <div className="grid gap-8 lg:grid-cols-12">
          <Reveal from="up" className="lg:col-span-7">
            <SectionLabel accent="cyan">Signage process</SectionLabel>
            <h2 className="display-md mt-6 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
              From Wall Measurement
              <br />
              To Final{" "}
              <span className="text-gradient-deep">Installation.</span>
            </h2>
          </Reveal>
          <Reveal
            from="up"
          ...
          >
            <p className="lede text-ink-2">
              Signage depends on more than artwork. Scale, material, fixing
              method, lighting and viewing distance all affect the final
              result.
            </p>
          </Reveal>
        </div>
          ...
          <ol className="relative mx-auto mt-16 grid max-w-5xl grid-cols-2 gap-x-16 gap-y-10 lg:grid-cols-4">
            ...
            {steps.map((step) => (
              ...
              >
                ...
                >
                  <SgIcon name={step.icon} className="size-16" />
                </span>
        ...
        <Reveal from="up" delay={0.3}>
          <p className="label-wide mt-14 text-center text-ink-3">
            Measured for the space. Built for the application.
          </p>
        </Reveal>
      </div>
    </section>
