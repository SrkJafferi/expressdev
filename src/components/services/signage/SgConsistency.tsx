          ...
          <div className="flex flex-col justify-center lg:col-span-6">
            <Reveal from="up">
              <div className="flex items-center gap-3.5">
                ...
                <SectionLabel accent="navy">
                  One brand. One physical language.
                </SectionLabel>
            ...
            <Reveal from="up" delay={0.1}>
              <h2 className="display-md mt-7 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
                ...
                <br />
                Door To{" "}
                <span className="text-gradient-deep">Skyline.</span>
              </h2>
            </Reveal>
            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  Your storefront sign, reception wall, wayfinding and
                  promotional signage should all feel like parts of the same
                  brand.
                </p>
                <p className="lede text-ink-2">
                  We manage scale, colour, materials and fabrication so every
                  physical touchpoint carries the same visual identity —
                  whether it is viewed from a few steps away or across a busy
                  street.
                </p>
                <p className="lede text-ink-2">
                  From first artwork to final installation, each piece is
                  checked for proportion, alignment and finish before
                  handover.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal from="up" delay={0.3}>
              <div className="mt-10 flex items-center gap-5">
                ...
                <span className="label-wide text-ink-3">
                  Designed · Fabricated · Installed — One Team
                </span>
              </div>
            </Reveal>
          </div>

          {/* ── Right — signage visual ──────────────────────────────── */}
          <Reveal
            from="right"
            delay={0.2}
          ...
          >
            <div className="relative h-full min-h-[420px]">
              ...
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/60 shadow-[0_30px_70px_-28px_rgba(16,48,90,0.45)]">
                <Image
                  src="https://images.unsplash.com/photo-1659993447069-e00b561168d4?auto=format&fit=crop&w=1000&h=1250&q=85"
                  alt="Illuminated 3D dimensional lettering produced and installed by Express Advertising"
                  fill
              ...
              <div className="absolute -left-4 top-6 rounded-xl border border-navy-100 bg-white/95 px-4 py-3 shadow-[0_16px_40px_-14px_rgba(16,48,90,0.35)] backdrop-blur-sm sm:-left-6">
                <p className="label-wide text-cyan">Built In-House</p>
