          ...
          <div className="flex flex-col justify-center lg:col-span-6">
            ...
            <Reveal from="up" delay={0.1}>
              <h2 className="display-md mt-7 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
                ...
                <br />
                Screen To{" "}
                <span className="text-gradient-deep">Street.</span>
              </h2>
            </Reveal>
            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  A campaign should feel like the same brand whether someone
                  sees it on a storefront window, exhibition backdrop, vehicle
                  or retail display.
                </p>
                <p className="lede text-ink-2">
                  We manage artwork preparation, scaling, colour and output so
                  large-format graphics stay visually consistent across
                  different sizes, materials and environments.
                </p>
                <p className="lede text-ink-2">
                  From the first proof to the final application, every element
                  is checked for clarity, proportion and brand consistency.
                  That means your campaign can move from a small visual
                  reference to a large physical space without losing the
                  details that make it recognisable.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal from="up" delay={0.3}>
              <div className="mt-10 flex items-center gap-5">
                ...
                <span className="label-wide text-ink-3">
                  Scaled · Proofed · Produced — One Team
                </span>
              </div>
            </Reveal>
          </div>

          {/* ── Right — campaign visual collage ─────────────────────── */}
          <Reveal
            from="right"
            delay={0.2}
          ...
          >
            <div className="relative h-full min-h-[420px]">
              ...
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/60 shadow-[0_30px_70px_-28px_rgba(16,48,90,0.45)]">
                <Image
                  src="https://images.unsplash.com/photo-1777751776405-f12e57b7a855?auto=format&fit=crop&w=1000&h=1250&q=85"
                  alt="Large format campaign graphics produced by Express Advertising"
                  fill
                ...
                <div className="absolute inset-x-4 bottom-4 flex items-center justify-between rounded-xl border border-white/15 bg-navy-900/75 px-4 py-3 backdrop-blur-md">
                  <div>
                    <p className="label-wide text-cyan-bright">
                      Large Format Campaign Suite
                    </p>
                    <p className="label-wide mt-0.5 text-white/55">
                      Retail · Events · Outdoor
                    </p>
                  </div>
                  <CropMarks
                    color="white"
              ...
              <div className="absolute -left-4 top-6 rounded-xl border border-navy-100 bg-white/95 px-4 py-3 shadow-[0_16px_40px_-14px_rgba(16,48,90,0.35)] backdrop-blur-sm sm:-left-6">
                <p className="label-wide text-cyan">Campaign Ready</p>
                <p className="mt-0.5 text-[0.6875rem] font-semibold text-navy-900">
                  Scaled · Proofed · Produced
                </p>
              </div>
            </div>
          </Reveal>
