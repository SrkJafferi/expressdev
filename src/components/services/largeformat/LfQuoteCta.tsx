        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal from="up" delay={0.1}>
            <h2 className="display-md mt-5 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-white">
              ...
              <br />
              Let&apos;s{" "}
              <span className="text-gradient-hero">Print It.</span>
            </h2>
          </Reveal>

          <Reveal from="up" delay={0.2}>
            <p className="lede mx-auto mt-5 max-w-xl text-white/65">
              Tell us the size, quantity, application and where the graphic
              will be used. Our team will help you choose the right production
              approach and prepare it for maximum visual impact.
            </p>
          </Reveal>

          <Reveal from="up" delay={0.3}>
            <QuoteInlineForm service="Large Format Printing" />
          </Reveal>
          ...
          <Reveal from="up" delay={0.4}>
            ...
            >
              Need a standard ready-to-order product? Shop Online
