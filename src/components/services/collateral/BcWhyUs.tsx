...
const benefits = [
  {
    ...
    body: "Artwork and output prepared for consistent reproduction across printed pieces.",
    icon: "colour",
    accent: "cyan",
  },
  {
    title: "One Production Workflow",
    body: "Design, printing and finishing within one accountable process.",
    icon: "workflow",
    accent: "magenta",
  },
  {
    title: "Premium Finishing",
    body: "Papers, lamination, foil and cutting coordinated around the brand.",
    icon: "finishing",
    accent: "yellow",
  },
  {
    title: "UAE-Focused Delivery",
    body: "Commercial print and collateral production across the UAE.",
    icon: "pin",
    accent: "cyan",
  },
] as const;
            ...
            return (
              <Reveal key={item.title} from="up" delay={i * 0.1}>
                <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-white/25 sm:p-7">
                  ...
                  >
                    <BcIcon name={item.icon} className="size-9" />
                  </span>
