        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal from="up" delay={0.1}>
            <h2 className="display-md mt-5 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-white">
              ...
              <br />
              Brand Collateral{" "}
              <span className="text-gradient-hero">Suite?</span>
            </h2>
          </Reveal>

          <Reveal from="up" delay={0.2}>
            <p className="lede mx-auto mt-5 max-w-xl text-white/65">
              Send us your logo, brand guidelines and the items you need. We
              can help coordinate the artwork, materials and finishing so the
              complete set feels consistent from the first piece to the last.
            </p>
          </Reveal>

          <Reveal from="up" delay={0.3}>
            <QuoteInlineForm service="Brand Collateral" />
          </Reveal>
          ...
          <Reveal from="up" delay={0.4}>
            ...
            >
              Need standard ready-to-order print? Shop Online
