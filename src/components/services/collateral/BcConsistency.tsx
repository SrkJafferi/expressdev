            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  Your customer may see a quotation, a folder, a company
                  profile and a product tag at completely different moments —
                  but every piece should still feel like it comes from the
                  same organisation.
                </p>
                <p className="lede text-ink-2">
                  We coordinate typography, colour, paper, finishing and
                  artwork preparation across your collateral so nothing feels
                  disconnected.
                </p>
                <p className="lede text-ink-2">
                  From internal documents to customer-facing presentation
                  pieces, the goal is simple: one visual standard across every
                  printed interaction.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal from="up" delay={0.3}>
              <div className="mt-10 flex items-center gap-5">
                ...
                <span className="label-wide text-ink-3">
                  Prepared · Matched · Approved — One Team
                </span>
              </div>
            </Reveal>
          </div>

          {/* ── Right — bright collateral presentation ──────────────── */}
          <Reveal
            from="right"
            delay={0.2}
          ...
          >
            <div className="relative h-full min-h-[420px]">
              ...
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/60 shadow-[0_30px_70px_-28px_rgba(16,48,90,0.45)]">
                <Image
                  src="https://plus.unsplash.com/premium_photo-1752231227830-20cee47c4663?auto=format&fit=crop&w=1000&h=1250&q=85"
                  alt="Bright coordinated corporate collateral presentation"
                  fill
                ...
                <div className="absolute inset-x-4 bottom-4 flex items-center justify-between rounded-xl border border-white/15 bg-navy-900/75 px-4 py-3 backdrop-blur-md">
                  <div>
                    ...
                    <p className="label-wide mt-0.5 text-white/55">
                      Stationery · Presentation · Documentation
                    </p>
                  </div>
                  <CropMarks
                    color="white"
              ...
              <div className="absolute -left-4 top-6 rounded-xl border border-navy-100 bg-white/95 px-4 py-3 shadow-[0_16px_40px_-14px_rgba(16,48,90,0.35)] backdrop-blur-sm sm:-left-6">
                <p className="label-wide text-cyan">Brand Control</p>
                <p className="mt-0.5 text-[0.6875rem] font-semibold text-navy-900">
                  Prepared · Matched · Approved
                </p>
              </div>
            </div>
          </Reveal>
