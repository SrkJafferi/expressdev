...
const steps = [
  {
    index: "01",
    label: "BRIEF",
    caption: "Brand assets · Items · Quantities",
    icon: "brief",
  ...
  },
  {
    index: "04",
    label: "CHECK",
    caption: "Match · Pack · Deliver",
    icon: "check",
    accent: "border-yellow/70 text-[#c9a800]",
  },
] as const;

export function BcProcess() {
  return (
      ...
      <div className="shell relative z-10">
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          >
            <p className="lede text-ink-2">
              We use one approved visual direction as the reference point
              across every item, helping keep colour, layout and finishing
          ...
          <ol className="relative mx-auto mt-16 grid max-w-5xl grid-cols-2 gap-x-16 gap-y-10 lg:grid-cols-4">
            ...
            {steps.map((step) => (
              ...
              >
                ...
                >
                  <BcIcon name={step.icon} className="size-16" />
                </span>
        ...
        <Reveal from="up" delay={0.3}>
          <p className="label-wide mt-14 text-center text-ink-3">
            One reference point across every item
          </p>
        </Reveal>
      </div>
    </section>
