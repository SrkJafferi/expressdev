...
const steps = [
  {
    index: "01",
    label: "ASSESS",
    caption: "Needs · Systems · Priorities",
    icon: "assess",
  ...
  },
  {
    index: "02",
    label: "PLAN",
    caption: "Solution · Structure · Security",
    icon: "plan",
  ...
  },
  {
    index: "03",
    label: "IMPLEMENT",
    caption: "Configure · Integrate · Deploy",
    icon: "implement",
  ...
  },
  {
    index: "04",
    label: "SUPPORT",
    caption: "Monitor · Maintain · Improve",
    icon: "support",
      ...
      <div className="shell relative z-10">
        <div className="grid gap-8 lg:grid-cols-12">
          <Reveal from="up" className="lg:col-span-7">
            <SectionLabel accent="cyan">IT service workflow</SectionLabel>
          ...
          >
            <p className="lede text-ink-2">
              Every business has different technology requirements. We start
              with the problem to be solved, then plan the right
              implementation and support approach around it.
            </p>
          </Reveal>
        </div>

        {/* 2x2 / 4-across circular node timeline with network markers */}
        <Reveal from="up" delay={0.2}>
          <ol className="relative mx-auto mt-16 grid max-w-5xl grid-cols-2 gap-x-16 gap-y-10 lg:grid-cols-4">
            {/* Connecting line + network markers — desktop only */}
            <span
              aria-hidden
            ...
            {steps.map((step) => (
              ...
              >
                ...
                >
                  <ItIcon name={step.icon} className="size-16" />
                </span>
        ...
        <Reveal from="up" delay={0.3}>
          <p className="label-wide mt-14 text-center text-ink-3">
            Technology planned around the way your business operates
          </p>
        </Reveal>
      </div>
    </section>
