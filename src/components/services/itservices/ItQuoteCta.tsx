        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal from="up" delay={0.2}>
            <p className="lede mx-auto mt-5 max-w-xl text-white/65">
              Tell us what you are trying to build, improve or fix. Share your
              current setup and the challenge you are facing, and our team can
              help identify the right next step.
            </p>
          </Reveal>

          <Reveal from="up" delay={0.3}>
            <QuoteInlineForm service="IT Services" />
          </Reveal>
          ...
          <Reveal from="up" delay={0.4}>
            ...
            >
              Need design or brand production too? Explore Services
