          ...
          <div className="flex flex-col justify-center lg:col-span-6">
            <Reveal from="up">
              <div className="flex items-center gap-3.5">
                ...
                <SectionLabel accent="navy">Built to keep working</SectionLabel>
            ...
            <Reveal from="up" delay={0.1}>
              <h2 className="display-md mt-7 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
                ...
                <span className="text-gradient-deep">Think About It.</span>
              </h2>
            </Reveal>
            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  The best business technology often works quietly in the
                  background.
                </p>
                <p className="lede text-ink-2">
                  Websites stay available. Communication keeps moving. Systems
                  remain maintained. Teams know where to get support when
                  something goes wrong.
                </p>
                <p className="lede text-ink-2">
                  Our approach is built around practical reliability —
                  understanding what the business actually depends on and
                  maintaining those systems with clarity and accountability.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal from="up" delay={0.3}>
              <div className="mt-10 flex items-center gap-5">
                ...
                <span className="label-wide text-ink-3">
                  Planned · Implemented · Supported — One Team
                </span>
              </div>
            </Reveal>
          </div>

          {/* ── Right — infrastructure composition ──────────────────── */}
          <Reveal
            from="right"
            delay={0.2}
          ...
          >
            <div className="relative h-full min-h-[420px]">
              ...
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/60 shadow-[0_30px_70px_-28px_rgba(16,48,90,0.45)]">
                <Image
                  src="https://images.unsplash.com/photo-1554098415-788601c80aef?auto=format&fit=crop&w=1000&h=1250&q=85"
                  alt="Business infrastructure — hosting and network systems"
                  fill
              ...
              <div className="absolute -left-4 top-6 rounded-xl border border-navy-100 bg-white/95 px-4 py-3 shadow-[0_16px_40px_-14px_rgba(16,48,90,0.35)] backdrop-blur-sm sm:-left-6">
                <p className="label-wide text-cyan">Connected Systems</p>
                <p className="mt-0.5 text-[0.6875rem] font-semibold text-navy-900">
                  Planned · Implemented · Supported
                </p>
              </div>
            </div>
          </Reveal>
