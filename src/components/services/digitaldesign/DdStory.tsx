          ...
          <div className="flex flex-col justify-center lg:col-span-6">
            <Reveal from="up">
              <div className="flex items-center gap-3.5">
                ...
                <SectionLabel accent="navy">From screen to space</SectionLabel>
            ...
            <Reveal from="up" delay={0.1}>
              <h2 className="display-md mt-7 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
                ...
                <br />
                Built To Work{" "}
                <span className="text-gradient-deep">Everywhere.</span>
              </h2>
            </Reveal>
            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  A brand identity should not fall apart when it moves from a
                  screen to a business card, storefront sign, exhibition
                  backdrop or promotional product.
                </p>
                <p className="lede text-ink-2">
                  Because design and production sit within the same broader
                  workflow, we can prepare creative work with the final
                  application in mind.
                </p>
                <p className="lede text-ink-2">
                  Colour, scale, typography and artwork structure are
                  considered early so the identity remains recognisable across
                  different media.
                </p>
                <p className="lede text-ink-2">
                  The result is a brand that feels connected whether someone
                  sees it on a phone, a printed brochure or a large physical
                  installation.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal from="up" delay={0.3}>
              <div className="mt-10 flex items-center gap-5">
                ...
                <span className="label-wide text-ink-3">
                  Digital · Print · Physical — One Team
                </span>
              </div>
            </Reveal>
          </div>

          {/* ── Right — screen-to-space visual ──────────────────────── */}
          <Reveal
            from="right"
            delay={0.2}
          ...
          >
            <div className="relative h-full min-h-[420px]">
              ...
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/60 shadow-[0_30px_70px_-28px_rgba(16,48,90,0.45)]">
                <Image
                  src="https://images.unsplash.com/photo-1611241893603-3c359704e0ee?auto=format&fit=crop&w=1000&h=1250&q=85"
                  alt="Brand identity applied across screens, print and physical touchpoints"
                  fill
