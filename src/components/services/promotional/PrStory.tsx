          ...
          <div className="flex flex-col justify-center lg:col-span-6">
            ...
            <Reveal from="up" delay={0.1}>
              <h2 className="display-md mt-7 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
                ...
                <br />
                To Brand{" "}
                <span className="text-gradient-deep">Keepsake.</span>
              </h2>
            </Reveal>
            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  A promotional product should feel like an extension of your
                  identity, not an item with a logo added at the last minute.
                </p>
                <p className="lede text-ink-2">
                  We coordinate product selection, artwork placement, colour
                  and presentation so merchandise works alongside your wider
                  campaign and brand collateral.
                </p>
                <p className="lede text-ink-2">
                  From an exhibition giveaway to an executive gift, every item
                  should carry the same visual standard and attention to
                  detail.
                </p>
                <p className="lede text-ink-2">
                  When multiple products are being produced for the same
                  campaign, we keep the branding direction aligned across the
                  complete set.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal from="up" delay={0.3}>
              <div className="mt-10 flex items-center gap-5">
                ...
                <span className="label-wide text-ink-3">
                  Selected · Branded · Checked — One Team
                </span>
              </div>
            </Reveal>
          </div>

          {/* ── Right — branded collection visual ───────────────────── */}
          <Reveal
            from="right"
            delay={0.2}
          ...
          >
            <div className="relative h-full min-h-[420px]">
              ...
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/60 shadow-[0_30px_70px_-28px_rgba(16,48,90,0.45)]">
                <Image
                  src="/banner2.avif"
                  alt="Branded promotional collection — bags, drinkware, apparel and corporate gifts"
                  fill
              ...
              <div className="absolute -left-4 top-6 rounded-xl border border-navy-100 bg-white/95 px-4 py-3 shadow-[0_16px_40px_-14px_rgba(16,48,90,0.35)] backdrop-blur-sm sm:-left-6">
                <p className="label-wide text-cyan">Brand Ready</p>
                <p className="mt-0.5 text-[0.6875rem] font-semibold text-navy-900">
                  Selected · Branded · Checked
                </p>
              </div>
            </div>
          </Reveal>
