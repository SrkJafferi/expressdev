        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal from="up" delay={0.1}>
            <h2 className="display-md mt-5 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-white">
              ...
              <br />
              Event Or Corporate{" "}
              <span className="text-gradient-hero">Gift?</span>
            </h2>
          </Reveal>

          <Reveal from="up" delay={0.2}>
            <p className="lede mx-auto mt-5 max-w-xl text-white/65">
              Tell us what you are promoting, who the products are for and the
              approximate quantity. We&apos;ll help you shortlist suitable
              promotional items and branding options.
            </p>
          </Reveal>

          <Reveal from="up" delay={0.3}>
            <QuoteInlineForm service="Promotional Items" />
          </Reveal>
          ...
          <Reveal from="up" delay={0.4}>
            ...
            >
              Looking for standard ready-to-order products? Shop Online
