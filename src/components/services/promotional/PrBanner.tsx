  ...
  return (
    <section className="relative isolate overflow-hidden bg-navy-900 text-white">
      <div className="relative h-[460px] min-h-[420px] w-full lg:h-[500px]">
        {/* Background image — branded merchandise composition */}
        <Image
          src="/banner2.avif"
          alt=""
          fill
        ...
        {/* Faint product silhouette geometry */}
        <svg
          aria-hidden
        ...
        >
          {/* Bag silhouette */}
          <path d="M30 90h70l8 110H22z" stroke="var(--color-cyan)" strokeWidth="1" />
          <path d="M50 90V70a15 15 0 0 1 30 0v20" stroke="var(--color-cyan)" strokeWidth="1" />
          {/* Mug silhouette */}
          <path d="M150 120h55v70h-55z" stroke="var(--color-magenta)" strokeWidth="1" />
          <path d="M205 135h12a12 12 0 0 1 0 40h-12" stroke="var(--color-magenta)" strokeWidth="1" />
          {/* Bottle silhouette */}
          <path d="M260 100c8 8 8 20 8 30v50h-20v-50c0-10 0-22 8-30v-12h4z" stroke="var(--color-yellow)" strokeWidth="1" />
          {/* Registration accents */}
          <circle cx="30" cy="90" r="2.5" fill="var(--color-cyan)" />
          <circle cx="205" cy="120" r="2.5" fill="var(--color-magenta)" />
          <circle cx="248" cy="180" r="2.5" fill="var(--color-yellow)" />
        </svg>
            ...
            <div className="flex flex-wrap items-center justify-between gap-y-4 gap-x-8">
              ...
              <div className="max-w-3xl">
                ...
                <Reveal from="up" delay={0.18}>
                  <h1 className="display-md mt-3 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] font-extrabold text-white">
                    ...
                    <br />
                    In Every{" "}
                    <span className="text-cyan-bright">Hand.</span>
                  </h1>
                </Reveal>

                <Reveal from="up" delay={0.26}>
                  <p className="mt-5 max-w-xl text-sm leading-relaxed text-white/65 sm:text-[0.9375rem]">
                    From everyday giveaways to premium corporate gifts, we
                    create branded promotional products designed to keep your
                    business visible, useful and remembered.
                  </p>
                </Reveal>
              </div>
              ...
              <Reveal from="up" className="shrink-0">
                ...
                >
                  ...
                  <span aria-hidden className="text-white/30">/</span>
                  <span className="text-cyan-bright">Promotional Items</span>
                </nav>
              </Reveal>
            </div>
          </div>
