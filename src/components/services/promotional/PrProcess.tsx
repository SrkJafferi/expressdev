...
const steps = [
  {
    index: "01",
    label: "SELECT",
    caption: "Product · Quantity · Purpose",
    icon: "select",
  ...
  },
  {
    index: "02",
    label: "BRAND",
    caption: "Artwork · Position · Method",
    icon: "branding",
  ...
  },
  {
    index: "03",
    label: "PRODUCE",
    caption: "Print · Engrave · Embroider",
    icon: "produce",
  ...
  },
  {
    index: "04",
    label: "CHECK & PACK",
    caption: "Quality · Presentation · Delivery",
    icon: "pack",
      ...
      <div className="shell relative z-10">
        <div className="grid gap-8 lg:grid-cols-12">
          <Reveal from="up" className="lg:col-span-7">
            <SectionLabel accent="cyan">How we build a promotional range</SectionLabel>
            <h2 className="display-md mt-6 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
              From Product Selection
              <br />
              To Final{" "}
              <span className="text-gradient-deep">Presentation.</span>
            </h2>
          </Reveal>
          <Reveal
            from="up"
          ...
          >
            <p className="lede text-ink-2">
              A successful promotional item needs the right product, branding
              method, placement and finish. We coordinate each stage so the
              final merchandise feels consistent with your brand.
            </p>
          </Reveal>
        </div>
          ...
          <ol className="relative mx-auto mt-16 grid max-w-5xl grid-cols-2 gap-x-16 gap-y-10 lg:grid-cols-4">
            ...
            {steps.map((step) => (
              ...
              >
                ...
                >
                  <PrIcon name={step.icon} className="size-16" />
                </span>
        ...
        <Reveal from="up" delay={0.3}>
          <p className="label-wide mt-14 text-center text-ink-3">
            Every item prepared around the brand and application
          </p>
        </Reveal>
      </div>
    </section>
