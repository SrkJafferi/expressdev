...
export function PrintQuoteCta() {
  return (
    <section className="relative isolate overflow-hidden bg-navy-900 py-20 text-white lg:py-28">
      {/* Background image layer — same treatment as the About page CTA */}
      ...
      {/* Registration dots */}
      <span aria-hidden className="reg-dots absolute bottom-6 left-6 hidden lg:flex">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal from="up" delay={0.1}>
            <h2 className="display-md mt-5 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-white">
              Have Something{" "}
              <span className="text-gradient-hero">Ready To Print?</span>
            </h2>
          </Reveal>

          <Reveal from="up" delay={0.2}>
            <p className="lede mx-auto mt-5 max-w-xl text-white/65">
              Send us your artwork, quantity, size and finishing requirement —
              our team will help confirm the right production setup.
            </p>
          </Reveal>

          <Reveal from="up" delay={0.3}>
            <QuoteInlineForm service="Printing Services" />
          </Reveal>
          ...
          <Reveal from="up" delay={0.4}>
            ...
            >
              Need a standard ready-to-order item? Shop Online
