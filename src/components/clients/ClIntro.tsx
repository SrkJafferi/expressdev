          ...
          <div className="flex flex-col justify-center lg:col-span-6">
            ...
            <Reveal from="up" delay={0.1}>
              <h2 className="display-md mt-7 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-navy-900">
                ...
                <br />
                One Standard Of{" "}
                <span className="text-gradient-deep">Execution.</span>
              </h2>
            </Reveal>
            ...
            <Reveal from="up" delay={0.2}>
              <div className="mt-8 max-w-lg space-y-4">
                <p className="lede text-ink-2">
                  Every client brings a different brief, audience and
                  production challenge.
                </p>
                <p className="lede text-ink-2">
                  Our role is to make the process easier — from artwork
                  preparation and material selection to production, finishing
                  and delivery.
                </p>
                <p className="lede text-ink-2">
                  Whether the requirement is a single printed item, a retail
                  campaign, signage project, promotional merchandise or a
                  wider brand rollout, we focus on delivering work that feels
                  considered, consistent and ready for the real world.
                </p>
              </div>
            </Reveal>
          </div>

          {/* ── Right — single brand production image ───────────────── */}
          <Reveal
            from="right"
            delay={0.2}
          ...
          >
            <div className="relative h-full min-h-[420px]">
              ...
              <div className="group relative h-full overflow-hidden rounded-2xl shadow-[0_24px_60px_-24px_rgba(16,48,90,0.4)]">
                <Image
                  src="https://plus.unsplash.com/premium_photo-1661768507909-f961fcff0d45?auto=format&fit=crop&w=1000&h=1250&q=85"
                  alt="Premium brand production work by Express Advertising"
                  fill
              ...
              <div className="absolute -left-4 bottom-10 rounded-xl border border-navy-100 bg-white/95 px-4 py-3 shadow-[0_14px_36px_-14px_rgba(16,48,90,0.35)] backdrop-blur-sm sm:-left-6">
                <p className="label-wide text-cyan">Design To Delivery</p>
