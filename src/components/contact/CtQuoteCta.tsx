    ...
    <section className="relative isolate overflow-hidden bg-navy-900 py-20 text-white lg:py-28">
      ...
      <div className="shell relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          <Reveal from="up">
            <p className="label-wide text-cyan-bright">READY WHEN YOU ARE</p>
          </Reveal>
          ...
          <Reveal from="up" delay={0.1}>
            <h2 className="display-md mt-5 overflow-visible text-balance pt-[0.06em] pb-[0.14em] pl-[0.03em] text-white">
              ...
              <br />
              We&apos;ll Help With{" "}
              <span className="text-gradient-hero">The Rest.</span>
            </h2>
          </Reveal>

          <Reveal from="up" delay={0.2}>
            <p className="lede mx-auto mt-5 max-w-xl text-white/65">
              Share your artwork, reference image, dimensions or even a rough
              idea. We&apos;ll help turn it into a clear production
              requirement.
            </p>
          </Reveal>
